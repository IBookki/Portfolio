...
export default function AboutMe() {
  return (
    <div className="self-center min-h-[calc(100vh-60px)] flex-col items-center justify-center p-10">
      ...
      <p className="pt-4 text-center text-lg text-slate-200 opacity-90">
      ...
      <p className="pt-4 text-center text-lg text-slate-200 opacity-90">
        ...
        attention to detail, while my current position as a cashier has enhanced
        my customer service abilities, including resolving conflicts calmly and
